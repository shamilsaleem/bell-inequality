...
Affiliated to the University of Calicut\\[1cm]

By\\[0.5cm]

\textbf{DEVI KRISHNA A}\\
(DVAXSPH034)\\[0.5cm]
...
This is to certify that \textbf{Ms. DEVI KRISHNA A} has worked on the topic
“\textbf{Beyond Classical Physics: Entanglement and Bell's Theorem}” at St. Joseph’s College Devagiri (Autonomous), Calicut, under my supervision and guidance. This work has been carried out for the partial fulfilment of the Bachelor of Science Degree in Physics, University of Calicut.

\vspace{1cm}
\noindent \textbf{GROUP MEMBERS}
\begin{enumerate}
\item SHAMIL SALEEM.C (DVAXSPH044)
\item ALAN A (DVAXSPH002)
\item NANDA R K (DVAXSPH035)
\item LAKSHMIPRIYA RAMESH (DVAXSPH039)
\end{enumerate}
